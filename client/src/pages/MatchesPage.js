            ...
            <div>
                ...
                <Table onRow={(record, rowIndex) => {
                    ...
                    <ColumnGroup title="Teams">
                        ...
                        <Column title="Away" dataIndex="Away" key="Away" sorter={(a, b) => a.Home.localeCompare(b.Home)} />
                    </ColumnGroup>
                    <ColumnGroup title="Goals">
                        <Column title="Home" dataIndex="HomeGoals" key="HomeGoals" sorter={(a, b) => a.HomeGoal - b.HomeGoal} />
                        <Column title="Away" dataIndex="AwayGoals" key="AwayGoals" sorter={(a, b) => a.HomeGoal - b.HomeGoal} />
                    </ColumnGroup>
